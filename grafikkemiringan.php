<?php
    ...
    //baca informasi kemiringan sumbu y pada grafik 19 data terakhir
    $kemiringan = mysqli_query($konek, "SELECT kemiringan FROM tb_monitoringselsurya WHERE ID>= '$ID_awal'
    and ID<= '$ID_akhir' ORDER BY id ASC");
?>
...
<div class="panel panel-primary">
    ...
    <div class = "panel-body">
        ...
        <canvas id = "ChartKemiringan"> </canvas>
        <!-- Gambar Grafik -->
        <script type = "text/javascript">
            //baca ID canvas tempat grafik akan diletakkan
            var canvas = document.getElementById('ChartKemiringan');
            ...
            var data ={
                ...
                datasets : [
                    ...
                    borderColor : "rgba(150, 75, 0)",
                    pointRadius : 3.5,
                    data : [
                        <?php
                           while($data_kemiringan = mysqli_fetch_array($kemiringan))
                           {
                            echo $data_kemiringan['kemiringan'].',' ;
                           }
                        ?>
                    ]
